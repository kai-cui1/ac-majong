...
| BL-038 | Bot 策略增量 P2–P5：P2 台数最大化（追求大牌）/ P3 攻防一体 / P4 蒙特卡洛 / P5 学习型 | 规则引擎/对局流程 | 待办（未排期；2026-09-22 自 BL-031 后续增量拆出） | 中 | BL-031 AI 机器人可扩展模块 P1 落地后拆出增量保持可追溯；复用 packages/ai 的 BotStrategy/BotContext 注册表与 rooms bot_personas 持久化 |
...
- 2026-09-21：BL-018 公开房间与大厅房间列表、BL-019 原型全横屏化、BL-020 先看吃再碰（均完成于 2026-09-18）→ `归档/2026-Q3.md`
- 2026-09-21：BL-021 保底台数展示（完成于 2026-09-19）→ `归档/2026-Q3.md`
- 2026-09-21：BL-022 服务端可观测性、BL-023 客户端错误遥测、BL-024 单局回放包导出、BL-026 结算事件补发、BL-029 听牌型新口径引擎实施（均完成于 2026-09-21）→ `归档/2026-Q3.md`
- 2026-09-21：清理活跃表残留行 BL-012 前端对局回放 UI（早已归档 2026-Q3，活跃表误留）
- 2026-09-22：BL-030 缺一门无字条件（缺陷修复，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-032 思考/响应时间可配置＋服务端权威截止（缺陷修复+功能，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-033 结算手牌区溢面板修复＋17 张设计（缺陷修复+设计，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-034 台数提示徽章移右下角（缺陷修复，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-035 侧/北家副露定位失配修复（缺陷修复，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-036 结算页庄/子凸出＋算番公式（设计优化，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-037 时间档入等待页玩法弹层（补 BL-031 遗留缺口，完成于 2026-09-22）→ `归档/2026-Q3.md`
- 2026-09-22：BL-031 AI 机器人可扩展模块（P1 范围：策略可插拔框架+最大概率打法+硬编码收敛+难度/策略 UI 入口+FR-AI-11 持久化，完成于 2026-09-22；后续增量 P2–P5 拆为 BL-038）→ `归档/2026-Q3.md`
- 2026-09-22：BL-038 副露原点失配修复（缺陷修复，完成于 2026-09-22）→ `归档/2026-Q3.md`

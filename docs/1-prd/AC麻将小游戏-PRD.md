...
| FR-积分-04 | **无跨房间积分账户 / 无赛季 / 无排行**（D-03/D-32）；但对局记录全量持久化用于审计/还原（arch 第11章） | P0 |
...
> **已迁至 backlog**：按文档职责约定，版本规划 / 里程碑 / 排期（“什么时候做”）统一维护在 [`docs/5-backlog/开发计划-路线图.md`](../5-backlog/开发计划-路线图.md)。PRD 只描述产品功能“做什么 / 怎么做”，不再维护排期。

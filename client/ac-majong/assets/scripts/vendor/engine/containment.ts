 ...
 * - 清一色⊇缺一门（N7；混一色含字、缺一门须无字（D-33），二者互斥故不再收录混一色吸收）；四姊妹⊇三姊妹；
 * - 九筒/九万高阶番⊇其基础番（特例1）。
 *
 * 听牌型互斥（新版D-13，2026-09-21）：独独/1独/对碰 由 classifyWait 与八对半分支在识别层
 * 产出唯一结果，三者天然互斥，不再靠「对碰⊇1独」吸收关系掩盖重复识别，故本表不再收录该条。
 *
 * 注意（N8/N9）：
